...
import 'package:vignette__mobile/features/board/data/repository/board_repository.dart';
...
Future<void> _initAuthDependencies() async {
  ...
  getIt.registerLazySingleton<LoginUseCase>(
    () => LoginUseCase(getIt(), getIt(), repository: getIt()),
  );
...
Future<void> _initBoardDependencies() async {
  // Data Sources
  getIt.registerLazySingleton<BoardLocalDataSource>(
    () => BoardLocalDataSourceImpl(getIt()),
  );

  getIt.registerLazySingleton<GetBoardsUseCase>(
    () => GetBoardsUseCase(getIt<IBoardRepository>()),
  );

  getIt.registerLazySingleton<CreateBoardUseCase>(
    () => CreateBoardUseCase(getIt<IBoardRepository>()),
  );

  getIt.registerLazySingleton<UpdateBoardUseCase>(
    () => UpdateBoardUseCase(getIt<IBoardRepository>()),
  );

  getIt.registerLazySingleton<DeleteBoardUseCase>(
    () => DeleteBoardUseCase(getIt<IBoardRepository>()),
  );

  getIt.registerLazySingleton<SyncBoardsUseCase>(
    () => SyncBoardsUseCase(getIt<IBoardRepository>()),
  );

  getIt.registerLazySingleton<ToggleFavoriteUseCase>(
    () => ToggleFavoriteUseCase(getIt<IBoardRepository>()),
  );

  getIt.registerLazySingleton<BoardRemoteDataSource>(
    () => BoardRemoteDataSource(getIt()),
  );

  // Repository
  getIt.registerLazySingleton<IBoardRepository>(
    () => BoardRepositoryImpl(
